                    ...
                    <div class="card-body">
                        <form action="<?= base_url($link); ?>" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_sanggar" name="nama_sanggar" placeholder="Nama sanggar" value="<?= set_value('nama_sanggar'); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="lokasi_sanggar" name="lokasi_sanggar" placeholder="lokasi sanggar"><?= set_value('lokasi_sanggar'); ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="tentang_sanggar" name="tentang_sanggar" placeholder="tentang sanggar"><?= set_value('tentang_sanggar'); ?></textarea>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="no_rek" name="no_rek" placeholder="no rek" value="<?= set_value('no_rek'); ?>">
                            </div>
