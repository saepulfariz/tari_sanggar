                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="harga_paket" name="harga_paket" disabled placeholder="harga_paket" value="">
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="bayar1" name="bayar1" placeholder="bayar1" value="0">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control" id="bayar2" name="bayar2" placeholder="bayar2" value="0">
                            </div>
                            <div class="form-group">
                                <label for="sisa">Sisa</label>
                                <input type="number" class="form-control" id="sisa" name="sisa" readonly placeholder="sisa" value="">
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="nama_acara" name="nama_acara" placeholder="nama_acara" value="<?= set_value('nama_acara'); ?>">
                            </div>
                            <?= form_error('nama_acara', '<div class="error text-danger mb-2" style="margin-top: -15px">', '</div>'); ?>
                            <div class="form-group">
                                <label for="tanggal_acara">Tanggal Acara</label>
                                <input type="date" class="form-control" id="tanggal_acara" name="tanggal_acara" placeholder="tanggal_acara" value="<?= set_value('tanggal_acara'); ?>">
                            </div>
                            <?= form_error('tanggal_acara', '<div class="error text-danger mb-2" style="margin-top: -15px">', '</div>'); ?>
                            <div class="form-group">
                                <label for="waktu_mulai">Waktu Mulai</label>
                                <input type="time" class="form-control" id="waktu_mulai" name="waktu_mulai" placeholder="waktu_mulai" value="<?= set_value('waktu_mulai'); ?>">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <textarea type="text" class="form-control" id="catatan_patner" name="catatan_patner" placeholder="catatan_patner"></textarea>
                            </div>
